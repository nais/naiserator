...
require (
	...
	github.com/nais/liberator v0.0.0-20221021133617-ade627372ed4
...
require (
	github.com/GoogleCloudPlatform/gke-fqdnnetworkpolicies-golang v0.0.0-20210504145059-d0ab0a61924b
