...
require (
	...
	github.com/nais/liberator v0.0.0-20230116141902-5d65b7f9256c
...
require (
	github.com/GoogleCloudPlatform/gke-fqdnnetworkpolicies-golang v0.0.0-20221209200223-0fa315e46e2a
