...
${CODEGEN_PKG}/generate-groups.sh "deepcopy,client,informer,lister" \
  ...
  "nais.io:v1alpha1 rbac.istio.io:v1alpha1 networking.istio.io:v1alpha3 iam.cnrm.cloud.google.com:v1alpha1 storage.cnrm.cloud.google.com:v1alpha2 sql.cnrm.cloud.google.com:v1alpha3" \
