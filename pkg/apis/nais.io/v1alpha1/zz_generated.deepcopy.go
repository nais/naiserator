...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VaultMounts) DeepCopyInto(out *VaultMounts) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VaultMounts.
func (in *VaultMounts) DeepCopy() *VaultMounts {
	if in == nil {
		return nil
	}
	out := new(VaultMounts)
