...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CloudIAMPolicyMember) DeepCopyInto(out *CloudIAMPolicyMember) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CloudIAMPolicyMember.
func (in *CloudIAMPolicyMember) DeepCopy() *CloudIAMPolicyMember {
	if in == nil {
		return nil
	}
	out := new(CloudIAMPolicyMember)
	in.DeepCopyInto(out)
	return out
}
...
func (in *GCP) DeepCopyInto(out *GCP) {
	*out = *in
	...
	if in.IAMPolicyMembers != nil {
		in, out := &in.IAMPolicyMembers, &out.IAMPolicyMembers
		*out = make([]CloudIAMPolicyMember, len(*in))
		copy(*out, *in)
	}
	return
}
