...
var iampolicymembersResource = schema.GroupVersionResource{Group: "iam.cnrm.cloud.google.com", Version: "v1beta1", Resource: "iampolicymembers"}

var iampolicymembersKind = schema.GroupVersionKind{Group: "iam.cnrm.cloud.google.com", Version: "v1beta1", Kind: "IAMPolicyMember"}

// Get takes name of the iAMPolicyMember, and returns the corresponding iAMPolicyMember object, and an error if there is any.
func (c *FakeIAMPolicyMembers) Get(name string, options v1.GetOptions) (result *v1beta1.IAMPolicyMember, err error) {
	obj, err := c.Fake.
...
func (c *FakeIAMPolicyMembers) List(opts v1.ListOptions) (result *v1beta1.IAMPolicyMemberList, err error) {
	obj, err := c.Fake.
...
func (c *FakeIAMPolicyMembers) Create(iAMPolicyMember *v1beta1.IAMPolicyMember) (result *v1beta1.IAMPolicyMember, err error) {
	obj, err := c.Fake.
...
func (c *FakeIAMPolicyMembers) Update(iAMPolicyMember *v1beta1.IAMPolicyMember) (result *v1beta1.IAMPolicyMember, err error) {
	obj, err := c.Fake.
...
func (c *FakeIAMPolicyMembers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.IAMPolicyMember, err error) {
	obj, err := c.Fake.
