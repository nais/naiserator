...
type IAMPolicyInterface interface {
	Create(*v1beta1.IAMPolicy) (*v1beta1.IAMPolicy, error)
	Update(*v1beta1.IAMPolicy) (*v1beta1.IAMPolicy, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.IAMPolicy, error)
	List(opts v1.ListOptions) (*v1beta1.IAMPolicyList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.IAMPolicy, err error)
	IAMPolicyExpansion
}
...
func (c *iAMPolicies) Get(name string, options v1.GetOptions) (result *v1beta1.IAMPolicy, err error) {
...
func (c *iAMPolicies) List(opts v1.ListOptions) (result *v1beta1.IAMPolicyList, err error) {
...
func (c *iAMPolicies) Create(iAMPolicy *v1beta1.IAMPolicy) (result *v1beta1.IAMPolicy, err error) {
	result = &v1beta1.IAMPolicy{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("iampolicies").
...
func (c *iAMPolicies) Update(iAMPolicy *v1beta1.IAMPolicy) (result *v1beta1.IAMPolicy, err error) {
	result = &v1beta1.IAMPolicy{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("iampolicies").
...
func (c *iAMPolicies) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.IAMPolicy, err error) {
	result = &v1beta1.IAMPolicy{}
