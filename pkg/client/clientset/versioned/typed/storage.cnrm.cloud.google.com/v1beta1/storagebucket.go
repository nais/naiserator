...
type StorageBucketInterface interface {
	Create(*v1beta1.StorageBucket) (*v1beta1.StorageBucket, error)
	Update(*v1beta1.StorageBucket) (*v1beta1.StorageBucket, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.StorageBucket, error)
	List(opts v1.ListOptions) (*v1beta1.StorageBucketList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.StorageBucket, err error)
...
func (c *storageBuckets) Get(name string, options v1.GetOptions) (result *v1beta1.StorageBucket, err error) {
...
func (c *storageBuckets) List(opts v1.ListOptions) (result *v1beta1.StorageBucketList, err error) {
...
func (c *storageBuckets) Create(storageBucket *v1beta1.StorageBucket) (result *v1beta1.StorageBucket, err error) {
	result = &v1beta1.StorageBucket{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagebuckets").
...
func (c *storageBuckets) Update(storageBucket *v1beta1.StorageBucket) (result *v1beta1.StorageBucket, err error) {
	result = &v1beta1.StorageBucket{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagebuckets").
...
func (c *storageBuckets) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.StorageBucket, err error) {
	result = &v1beta1.StorageBucket{}
