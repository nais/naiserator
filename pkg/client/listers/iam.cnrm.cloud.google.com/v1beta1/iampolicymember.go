...
type IAMPolicyMemberLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.IAMPolicyMember, err error)
...
// List lists all IAMPolicyMembers in the indexer.
func (s *iAMPolicyMemberLister) List(selector labels.Selector) (ret []*v1beta1.IAMPolicyMember, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.IAMPolicyMember))
	})
	return ret, err
}
...
type IAMPolicyMemberNamespaceLister interface {
	...
	Get(name string) (*v1beta1.IAMPolicyMember, error)
...
// List lists all IAMPolicyMembers in the indexer for a given namespace.
func (s iAMPolicyMemberNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.IAMPolicyMember, err error) {
...
// Get retrieves the IAMPolicyMember from the indexer for a given namespace and name.
func (s iAMPolicyMemberNamespaceLister) Get(name string) (*v1beta1.IAMPolicyMember, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("iampolicymember"), name)
	}
	return obj.(*v1beta1.IAMPolicyMember), nil
}
