...
type SQLUserLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.SQLUser, err error)
...
// List lists all SQLUsers in the indexer.
func (s *sQLUserLister) List(selector labels.Selector) (ret []*v1beta1.SQLUser, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.SQLUser))
	})
	return ret, err
}
...
type SQLUserNamespaceLister interface {
	...
	Get(name string) (*v1beta1.SQLUser, error)
...
// List lists all SQLUsers in the indexer for a given namespace.
func (s sQLUserNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.SQLUser, err error) {
...
// Get retrieves the SQLUser from the indexer for a given namespace and name.
func (s sQLUserNamespaceLister) Get(name string) (*v1beta1.SQLUser, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("sqluser"), name)
	}
	return obj.(*v1beta1.SQLUser), nil
}
