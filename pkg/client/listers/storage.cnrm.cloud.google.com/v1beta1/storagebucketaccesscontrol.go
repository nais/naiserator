...
type StorageBucketAccessControlLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.StorageBucketAccessControl, err error)
...
// List lists all StorageBucketAccessControls in the indexer.
func (s *storageBucketAccessControlLister) List(selector labels.Selector) (ret []*v1beta1.StorageBucketAccessControl, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.StorageBucketAccessControl))
	})
	return ret, err
}
...
type StorageBucketAccessControlNamespaceLister interface {
	...
	Get(name string) (*v1beta1.StorageBucketAccessControl, error)
...
// List lists all StorageBucketAccessControls in the indexer for a given namespace.
func (s storageBucketAccessControlNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.StorageBucketAccessControl, err error) {
...
// Get retrieves the StorageBucketAccessControl from the indexer for a given namespace and name.
func (s storageBucketAccessControlNamespaceLister) Get(name string) (*v1beta1.StorageBucketAccessControl, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("storagebucketaccesscontrol"), name)
	}
	return obj.(*v1beta1.StorageBucketAccessControl), nil
}
