...
// +kubebuilder:rbac:groups=nebula.skatteetaten.no,resources=Applications,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=nebula.skatteetaten.no,resources=Applications/status,verbs=get;update;patch;create
// +kubebuilder:rbac:groups=*,resources=events,verbs=get;list;watch;create;update

func (r *SkatteetatenApplicationReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	return r.Synchronizer.Reconcile(ctx, req, &skatteetaten_no_v1alpha1.Application{}, skatteetaten_resourcecreator.CreateSkatteetatenApplication)
}
