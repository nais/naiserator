...
func OpenSearch(ast *resource.Ast, openSearch *nais_io_v1.OpenSearch, aivenApp *aiven_nais_io_v1.AivenApplication) (bool, error) {
	...
	secretName, err := generateAivenSecretName(aivenApp.Name, "opensearch", aivenApp.Labels["aiven.nais.io/secret-generation"])
	if err != nil {
		return false, err
	}
	...
	aivenApp.Spec.OpenSearch = &aiven_nais_io_v1.OpenSearchSpec{
		Instance:   aiven_nais_io_v1.OpenSearchFullyQualifiedName(openSearch.Instance, aivenApp.GetNamespace()),
