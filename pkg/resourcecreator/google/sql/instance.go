...
func instanceIamPolicyMember(objectMeta metav1.ObjectMeta, resourceName string, googleProjectId, googleTeamProjectId, appNamespaceHash string) *google_iam_crd.IAMPolicyMember {
